<template>
  <div class="q-pa-md q-gutter-md">
    <q-list bordered class="rounded-borders my-card" style="max-width: 600px">
      <q-item-label header
        ><b class="text-h5 text-black">Examen Fisico</b></q-item-label
      >
      <q-separator />

      <q-item>
        <q-item-section avatar top>
          <q-icon name="mdi-cog" color="black" size="34px" />
        </q-item-section>
