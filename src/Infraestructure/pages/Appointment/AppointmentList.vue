<template>
  <!-- <div>'hlr'</div> -->
  <DataTable v-bind:tableOptions="result" />
  <!-- <q-table
    title="Treats"
    dense
    :rows="rows"
...
<script lang="ts">
import { BuilderTablesWithFetchToServer } from 'src/Adapters/DataTableAdapter';
import { ITableOptions, TableSelect } from 'src/Domine/ICommons';
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const builder = new BuilderTablesWithFetchToServer();
      builder.setData(columns.value, originalRows.value, 'Resumen Citas');
